        ...
        <div className="space-y-1">
          {cards.map((card) => (
            <article
              ...
              className={cn("rounded border px-2 py-1 text-xs", statusTone(card.status))}
            >
              ...
              {card.content ? (
                <p className="mt-1 whitespace-pre-wrap break-words text-[11px] leading-5">{card.content}</p>
              ) : (
