...
const FILE_TAB_MIN_WIDTH = 64;
const FILE_TAB_MAX_WIDTH = 176;
const FILE_TAB_HORIZONTAL_PADDING = 10;
const FILE_TAB_ACTION_WIDTH = 14;
const FILE_TAB_GAP_WIDTH = 3;
const FILE_TAB_DIRTY_WIDTH = 10;
const FILE_TAB_PREVIEW_BADGE_WIDTH = 54;
const EXTRA_TAB_MIN_WIDTH = 72;
const EXTRA_TAB_MAX_WIDTH = 168;
const EXTRA_TAB_HORIZONTAL_PADDING = 10;
const EXTRA_TAB_DIRTY_WIDTH = 10;
const EXTRA_TAB_BUTTON_WIDTH = 16;
const EXTRA_TAB_GAP_WIDTH = 3;
