...
const messages: Record<string, string> = {
  ...
  "workspace.compileAssist.hintBusytexWorkerOrigin": "worker origin issue",
...
describe("compileAssistHint", () => {
  it("filters BusyTeX progress noise and keeps priority errors", () => {
    const hint = buildCompileAssistHint([
      "BusyTeX reused cached package: ctex.sty.",
    ...
    expect(hint).not.toContain("BusyTeX reused cached package");
