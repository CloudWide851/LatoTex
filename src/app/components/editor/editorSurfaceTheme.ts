...
export function registerEditorSurfaceThemes(monaco: MonacoLike) {
  ...
  defineTheme(EDITOR_THEME_LIGHT, {
    ...
    colors: {
      ...
      "editorStickyScroll.background": "#f8fafcee",
      "editorStickyScrollHover.background": "#f1f5f9f2",
  ...
  defineTheme(EDITOR_THEME_DARK, {
    ...
    colors: {
      ...
      "editorGutter.background": "#00000000",
      "editorStickyScroll.background": "#111b29ee",
      "editorStickyScrollHover.background": "#172236f2",
