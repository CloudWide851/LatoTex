export const enUS_share = {
  ...
  "share.showPassword": "Show password",
  "share.hidePassword": "Hide password",
  "share.passwordHidden": "Password hidden",
  "share.passwordUnavailable": "Password unavailable",
  "share.passwordRevealFailed": "The password could not be retrieved. Refresh the session and try again.",
  ...
  "share.status.conflict": "Share needs conflict confirmation",
  "share.syncing": "Sharing (CRDT syncing)",
  "share.conflictTitle": "Collaborative edit conflict",
  "share.conflictDesc": "Local edits and remote collaborator edits changed the same document. Choose which version should be written back.",
  "share.conflictPath": "File",
  "share.conflictUseRemote": "Use remote version",
  "share.conflictKeepLocal": "Keep local version",
