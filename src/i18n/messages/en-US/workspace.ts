export const enUS_workspace = {
  ...
  "workspace.compileAssist.busytexFontFallbackApplied": "BusyTeX font fallback applied for missing system fonts: {details}.",
  "workspace.compileAssist.busytexFontFallbackUnavailable": "BusyTeX detected missing system fonts but no fallback mapping matched: {fonts}.",
  "workspace.compileAssist.busytexRetryingCompile": "BusyTeX is retrying compile with updated dependencies.",
  "workspace.compileAssist.busytexProgressInstalling": "Installing package {package}...",
  "workspace.compileAssist.busytexProgressPackages": "Package progress {completed}/{total}.",
  "workspace.undo": "Undo",
  "workspace.redo": "Redo",
