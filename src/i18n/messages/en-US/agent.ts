export const enUS_agent = {
  "agent.statusIdle": "Research assistant is waiting...",
  "agent.statusRunning": "Research assistant is analyzing...",
  "agent.statusDone": "Research task completed.",
  "agent.statusError": "Research task failed.",
  "agent.chatTitle": "Research Assistant",
  ...
  "agent.teams.run": "Run as review panel",
  ...
  "agent.task.generic": "Research Task",
