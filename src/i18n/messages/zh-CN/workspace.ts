export const zhCN_workspace = {
  ...
  "workspace.compileAssist.busytexFontFallbackApplied": "BusyTeX 已为缺失系统字体应用回退：{details}。",
  "workspace.compileAssist.busytexFontFallbackUnavailable": "BusyTeX 检测到缺失系统字体，但未匹配可用回退：{fonts}。",
  "workspace.compileAssist.busytexRetryingCompile": "BusyTeX 正在使用更新后的依赖重试编译。",
  "workspace.compileAssist.busytexProgressInstalling": "正在安装宏包 {package}...",
  "workspace.compileAssist.busytexProgressPackages": "宏包安装进度 {completed}/{total}。",
  "workspace.undo": "撤销",
  "workspace.redo": "重做",
