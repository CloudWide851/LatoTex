export const zhCN_agent = {
  "agent.statusIdle": "科研助手等待中...",
  "agent.statusRunning": "科研助手正在分析...",
  "agent.statusDone": "科研任务完成。",
  "agent.statusError": "科研任务失败。",
  "agent.chatTitle": "科研助手",
  "agent.collapse": "收起",
