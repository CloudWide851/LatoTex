export const zhCN_chat = {
  ...
  "chat.modeLabel": "对话模式",
  "chat.modeGeneral": "普通",
  "chat.modeResearch": "科研",
  "chat.contextLabel": "上下文范围",
  "chat.contextConversation": "仅当前对话",
  "chat.contextCurrentFile": "附加当前文件",
  "chat.attachCurrentFile": "将当前文件明确加入上下文",
  "chat.detachCurrentFile": "从上下文移除当前文件",
  ...
  "chat.error.storageMigrationFailed": "加密对话迁移失败，旧记录已保留，可安全重试。",
